...
public class HuntingCondition_MultiChain
{
    ...
    public bool Get_MultiChain_ConditionStatus(List<AnimalIdentity> animal_Die, List<AnimalIdentity> animal_Escape, List<AnimalIdentity> animal_Eaten)
    {
        ...
        {
            if(AllHuntingCondition_Chains[i].Get_Chain_ConditionStatus(animal_Die, animal_Escape, animal_Eaten) == true)
            {
